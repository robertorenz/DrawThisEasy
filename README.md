...
- **Import from Excalidraw** (File → Import from Excalidraw) — opens `.excalidraw` scenes as diagrams, mapping shapes, labels, and bound arrows into connections. Select several files to import them as separate tabs.
