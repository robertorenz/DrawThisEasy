...
public static class L10n
{
    ...
    private static readonly Dictionary<Language, Dictionary<string, string>> _strings = new()
    {
        [Language.En] = new()
        {
            ...
            ["manual.present.b.style"] = "Pick a background color and a transition: zoom out & in, smooth glide, pan then zoom, rotate & zoom, spring zoom, fade through background, instant cut, or Random (a different one each screen).",
        ...
        [Language.Es] = new()
        {
            ...
            ["manual.present.b.style"] = "Elige un color de fondo y una transición: alejar y acercar, deslizamiento suave, desplazar luego acercar, rotar y acercar, zoom con rebote, fundido a través del fondo, corte instantáneo o Aleatorio (una distinta en cada pantalla).",
