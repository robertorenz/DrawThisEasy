...
public static class L10n
{
    ...
    private static readonly Dictionary<Language, Dictionary<string, string>> _strings = new()
    {
        [Language.En] = new()
        {
            ...
            ["manual.present.b.style"] = "Pick a background color and a transition: zoom out & in, smooth glide, instant cut, or fade through background.",
        ...
        [Language.Es] = new()
        {
            ...
            ["manual.present.b.style"] = "Elige un color de fondo y una transición: alejar y acercar, deslizamiento suave, corte instantáneo o fundido a través del fondo.",
